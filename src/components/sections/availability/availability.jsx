...
class AvailabilitySection extends Component {
    ...
    render() {
        ...
        return (
            <div className="container" id="availabilityDiv">
                ...
                {!this.state.isLoading ? (
                    <>
                                    ...
                                    <tr className="property-variation-item" key={index}>
                                        {this.keys.map((key, i) =>
                                            key === 'construction plan' ?
                                                <td key={i} id={index}>
                                                    <a href={null} onClick={() => {this.setState({isOpen: true,photoIndex:index})}} className={`button-primary`}>View
                                                        Now</a>
                                                </td>
                                                :
                        ...
                        {isOpen && (
                            <Lightbox
                                mainSrc={this.data[photoIndex]['construction plan']}
