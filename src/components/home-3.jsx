                            ...
                            <div className="row no-gutters">
                                <div className="col-xl-3 col-md-6">
                                    <ImageBox
                                        ...
                                        bgImage={`${process.env.PUBLIC_URL}/assets/imagewebpss/home-3/the-building.webp`}
                                    >
                                    </ImageBox>
                                </div>
                                <div className="col-xl-3 col-md-6">
                                    <ImageBox
                                        ...
                                        bgImage={`${process.env.PUBLIC_URL}/assets/imagewebpss/home-3/amenities.webp`}
                                    >
                                    </ImageBox>
                                </div>
                                <div className="col-xl-3 col-md-6">
                                    <ImageBox
                                        ...
                                        bgImage={`${process.env.PUBLIC_URL}/assets/imagewebpss/home-3/neighbourhood.webp`}
                                    >
                                    </ImageBox>
                                </div>
                                <div className="col-xl-3 col-md-6">
                                    <ImageBox
                                        ...
                                        bgImage={`${process.env.PUBLIC_URL}/assets/imagewebpss/home-3/the-modern.webp`}
                                    >
                                    </ImageBox>
                                </div>
                            </div>
