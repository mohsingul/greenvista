...
class Testimonial extends Component {
    ...
    constructor (props) {
        ...
        this.sliderData = [
            {
                image: `${process.env.PUBLIC_URL}/assets/imagewebpss/testimonial/testimonial-1.webp`,
                name: 'John Smith',
                position: 'Customer',
            ...
            {
                image: `${process.env.PUBLIC_URL}/assets/imagewebpss/testimonial/testimonial-2.webp`,
                name: 'William',
                position: 'Designer',
                content: `They are the greatest. They are thoughtful, savvy and always take good care of my clients. It is a pleasure to recommend them. I know you will be pleased.`
            },
