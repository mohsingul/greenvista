    ...
    render (){
        ...
        return (
            <div className={`our-team-wrap`}>
                <Helmet>
                    <title>GreenVista | Our Team Page</title>
                </Helmet>
                    ...
                    <div className="container">
                        <div className="row align-items-center">
                            <div className="col-lg-6 col-md-12 col-sm-12 content-left">
                                ...
                                <div className="mt-5 pb-3"><img className="img-fluid" src="/assets/imagewebpss/ourteam/img_text.webp" alt=""/></div>
                            </div>
                            <div className="col-lg-6 col-md-12 col-sm-12">
                                <img className="img-fluid" src="/assets/imagewebpss/ourteam/img_1.webp" alt=""/>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="section-wrapper">
                    <Parallax
                        ...
                        bgImage={`${process.env.PUBLIC_URL}/assets/imagewebpss/ourteam/img_bg.webp`}
                        bgImageAlt="the cat"
                        strength={500}
                    >
                        ...
                        <div className="container">
                            ...
                            <div className="row no-gutters">
                                <div className="col-lg-3 col-md-6 col-sm-6">
                                    <OurTeamBlock img="/assets/imagewebpss/about/team_1.webp" name={`Connor Flores`} job={`JV PROPERTY MANAGEMENT`} position={`top`}>
                                        You may be a skillful, effective employer but if you don’t trust your personnel and the opposite, then the chances of
                                    </OurTeamBlock>
                                </div>
                                <div className="col-lg-3 col-md-6 col-sm-6">
                                    <OurTeamBlock img="/assets/imagewebpss/about/team_2.webp" name={`CAROLINE VAUGHN`} job={`PROJECT MANAGER`} position={`bottom`}>
                                        You may be a skillful, effective employer but if you don’t trust your personnel and the opposite, then the chances of
                                    </OurTeamBlock>
                                </div>
                                <div className="col-lg-3 col-md-6 col-sm-6">
                                    <OurTeamBlock img="/assets/imagewebpss/about/team_3.webp" name={`WILLIE TODD`} job={`SENIOR ARCHITECT`} position={`top`}>
                                        You may be a skillful, effective employer but if you don’t trust your personnel and the opposite, then the chances of
                                    </OurTeamBlock>
                                </div>
                                <div className="col-lg-3 col-md-6 col-sm-6">
